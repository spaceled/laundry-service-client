      ...
      <div className="grid my-10 py-10 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        <div className="card w-96 rounded-none">
          <figure className="px-10 pt-10">
            <svg className="h-48 w-48 text-base hover:text-green-500 ease-in-out duration-300" viewBox="0 0 24 24" strokeWidth="1" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">  <path stroke="none" d="M0 0h24v24H0z" />  <path d="M15 4l6 2v5h-3v8a1 1 0 0 1 -1 1h-10a1 1 0 0 1 -1 -1v-8h-3v-5l6 -2a3 3 0 0 0 6 0" /></svg>
          </figure>
